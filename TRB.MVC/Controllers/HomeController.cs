...
namespace TRB.MVC.Controllers
{
	public class HomeController : Controller
	{
		...
		public ActionResult Index()
		{
			...
			{
				Books = GetTestBookList(),
				Categories = CategoriesProvider.GetTestCategories()
			};

			return View("/Views/Home/Index.cshtml", homepageModel);
		}

		private static List<Book> GetTestBookList()
		{
